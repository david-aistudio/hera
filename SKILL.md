...
### 📚 Focused Reference Files (read only what you need)

The full SKILL.md is **~100KB / 3,277 lines**. For faster, focused reading, several sections are extracted into dedicated reference files:

| Topic | File | Source sections |
|---|---|---|
| **Agent loop, Agent class, AgentHarness** | [`references/agent-loop-harness.md`](references/agent-loop-harness.md) | SKILL.md §3–5 |
| **Session tree + compaction** | [`references/session-and-compaction.md`](references/session-and-compaction.md) | SKILL.md §6–7 |
| **AI provider abstraction** | [`references/ai-providers-layer.md`](references/ai-providers-layer.md) | SKILL.md §11 |

When the agent only needs one of these topics, **read the focused file** instead of all 3,277 lines. The main SKILL.md still contains the full reference but the pointers below indicate what has been extracted.
...
> 📚 **Focused reading**: See [`references/agent-loop-harness.md`](references/agent-loop-harness.md) for the full content of section 3 (agent loop — two-loop design, streaming flow, tool execution) extracted into a single file.

---

## 4. AGENT CLASS

> 📚 See [`references/agent-loop-harness.md`](references/agent-loop-harness.md) §2 (Agent class, PendingMessageQueue, run lifecycle, event processing).

---

## 5. AGENT HARNESS

> 📚 See [`references/agent-loop-harness.md`](references/agent-loop-harness.md) §3 (AgentHarness class, turn state, hook system, execute turn flow).

---

## 6. SESSION SYSTEM

> 📚 **Focused reading**: See [`references/session-and-compaction.md`](references/session-and-compaction.md) for the full content of section 6 (tree-based storage, Session class, context building, InMemorySessionStorage) extracted into a single file.

---

## 7. COMPACTION SYSTEM

> 📚 See [`references/session-and-compaction.md`](references/session-and-compaction.md) §2 (compaction settings, flow, summary format).
...
> 📚 **Focused reading**: See [`references/ai-providers-layer.md`](references/ai-providers-layer.md) for the full content of section 11 (provider system, streaming, tool calls, context, models, errors) extracted into a single file (~470 lines).
>
> **Topics covered**: Multi-provider support, streaming architecture, tool/function calls, model registry, error handling, context window, telemetry.
