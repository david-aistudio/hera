...
- 16 code templates (8 TypeScript + 8 Python, copy-paste ready)
...
### Way 1: npx skills (recommended)

```bash
npx skills add david-aistudio/hera
```

### Way 2: npx hera-agent
...
Copy the right file to the right place.
